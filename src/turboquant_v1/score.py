...
from .store import FlatCache, CompressedKVStore
from .kv_cache import dequantize_V
from .quantize import TurboQuant
...
def _attend_compressed_only(
    ...
    v_dequant = dequantize_V(flat.value_q, 32)
...
def _attend_hybrid(
    ...
    v_hist = dequantize_V(flat.value_q, 32)
