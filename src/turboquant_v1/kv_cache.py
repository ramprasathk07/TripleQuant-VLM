...
from .quantize import TurboQuant, ProdQuantized
...
class TurboQuantKVCache:
    ...
    def prefill(self, keys: torch.Tensor, values: torch.Tensor):
        ...
        self.value_quantized = quantize_V(
    ...
    def attention(self, attn_weights: torch.Tensor) -> torch.Tensor:
        """
        ...
        if self.value_quantized is not None:
            ...
            v_dequant = dequantize_V(self.value_quantized, self.value_group_size)
